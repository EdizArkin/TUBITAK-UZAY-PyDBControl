-- telecommand_unit2 tablosu için CREATE TABLE komutu
CREATE TABLE telecommand_unit2(
...
CMM1_mask INT  CHECK(CMM1_mask IN(1,3735928559)),
CMM1_expected_value INT CHECK(CMM1_expected_value IN(1,3735928559)),
CMM2_offset INT  CHECK(CMM2_offset BETWEEN 0 AND 2043),
CMM2_MASK  INT  CHECK(CMM2_MASK IN(1,3735928559)),
CMM2_expected_value INT  CHECK(CMM2_expected_value IN (1,3735928559)),
